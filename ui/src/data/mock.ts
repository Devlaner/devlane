...
export const mockAccountActivity: AccountActivityItem[] = [
  ...
  },
  {
    ...
    type: "label",
    description:
      "You added a new label Improvement to WEB-1 Implement login about 2 hours ago.",
    createdAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: "a3",
    ...
    type: "cycle",
    description:
      "You added WEB-1 Implement login to the cycle Sprint 1 about 2 hours ago.",
    createdAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: "a4",
    ...
    type: "assignee",
    description:
      "You added a new assignee alice to WEB-1 Implement login 3 days ago.",
...
export type YourWorkActivityType =
  | "label"
  | "cycle"
  | "assignee"
  | "created"
