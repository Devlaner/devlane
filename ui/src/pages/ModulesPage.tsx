...
export function ModulesPage() {
  ...
  const getIssueCount = (moduleId: string) => modules.find((m) => m.id === moduleId)?.issue_count ?? 0;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button type="button" className="flex size-8 items-center justify-center rounded-md text-[var(--txt-icon-tertiary)] hover:bg-[var(--bg-layer-2)] hover:text-[var(--txt-icon-secondary)]" aria-label="Assignees">
          <IconUser />
        </button>
        <button type="button" className="flex size-8 items-center justify-center rounded-md text-[var(--txt-icon-tertiary)] hover:bg-[var(--bg-layer-2)] hover:text-[var(--txt-icon-secondary)]" aria-label="Favorite">
          <IconStar />
        </button>
        <button type="button" className="flex size-8 items-center justify-center rounded-md text-[var(--txt-icon-tertiary)] hover:bg-[var(--bg-layer-2)] hover:text-[var(--txt-icon-secondary)]" aria-label="More">
          <IconMoreVertical />
        </button>
      </div>
      ...
      <div className="space-y-2">
        {modules.length === 0 ? (
          <p className="py-8 text-center text-sm text-[var(--txt-tertiary)]">No modules yet.</p>
        ) : (
          modules.map((mod) => {
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1 border-l border-[var(--border-subtle)] pl-4">
                  <p className="font-medium text-[var(--txt-primary)]">{mod.name}</p>
                </div>
                <div className="flex shrink-0 items-center gap-1 text-[var(--txt-icon-tertiary)]">
                  <span className="flex size-8 items-center justify-center rounded hover:bg-[var(--bg-layer-1-hover)] hover:text-[var(--txt-icon-secondary)]" title="Start date → End date">
                    <IconCalendar />
                  </span>
                  <span className="flex size-8 items-center justify-center rounded hover:bg-[var(--bg-layer-1-hover)] hover:text-[var(--txt-icon-secondary)]" title="Backlog">
                    <IconLuggage />
                  </span>
                  <span className="flex size-8 items-center justify-center rounded hover:bg-[var(--bg-layer-1-hover)] hover:text-[var(--txt-icon-secondary)]" title="Assignees">
                    <IconUser />
                  </span>
                  <span className="flex size-8 items-center justify-center rounded hover:bg-[var(--bg-layer-1-hover)] hover:text-[var(--txt-icon-secondary)]" title="Favorite">
                    <IconStar />
                  </span>
                  <button
                    type="button"
