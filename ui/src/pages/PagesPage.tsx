...
const IconAlertTriangle = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 text-[var(--warning-default)]" aria-hidden>
        ...
        {filteredPages.length === 0 ? (
          ...
          <ul className="divide-y divide-[var(--border-subtle)]">
            {filteredPages.map((page) => {
              const updatedBy = getUser(page.updated_by_id ?? null);
              return (
                <li key={page.id}>
                  <Link
                  ...
                  >
                    ...
                    <div className="flex shrink-0 items-center gap-2 text-[var(--txt-icon-tertiary)]">
                      {updatedBy && (
                        <Avatar name={updatedBy.name} src={updatedBy.avatarUrl} size="sm" className="h-6 w-6 text-[10px]" />
                      )}
                      <span className="flex size-8 items-center justify-center rounded hover:bg-[var(--bg-layer-1-hover)] hover:text-[var(--txt-icon-secondary)]" title="Visibility">
                        <IconGlobe />
                      </span>
                      <span className="flex size-8 items-center justify-center rounded hover:bg-[var(--bg-layer-1-hover)] hover:text-[var(--txt-icon-secondary)]" title="Info">
                        <IconInfo />
                      </span>
