      ...
      <div className="overflow-x-auto rounded-md border border-[var(--border-subtle)] bg-[var(--bg-surface-1)]">
        <table className="w-full min-w-[800px] text-left text-sm">
          ...
          <tbody>
            {issues.length === 0 ? (
              <tr>
                <td colSpan={11} className="py-12 text-center text-sm text-[var(--txt-tertiary)]">
              ...
              issues.map((issue) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-2.5 pr-4">
                      <button type="button" className="text-[var(--txt-secondary)] hover:text-[var(--txt-primary)]">
                        {assignee ? (
                          <span className="flex items-center gap-1.5">
                            <Avatar name={assignee.name} src={assignee.avatarUrl} size="sm" className="h-5 w-5 text-[10px]" />
                            {assignee.name}
                          </span>
                        ) : (
                          'Assignees'
                    ...
                    <td className="py-2.5 pr-4">
                      <button type="button" className="text-[var(--txt-secondary)] hover:text-[var(--txt-primary)]">
                        {labelNames.length > 0 ? labelNames.join(', ') : 'Select labels'}
                      </button>
                    </td>
                    <td className="py-2.5 pr-4">
                      <button type="button" className="text-[var(--txt-secondary)] hover:text-[var(--txt-primary)]">
