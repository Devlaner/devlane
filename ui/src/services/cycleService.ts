...
export const cycleService = {
  ...
  async addIssue(workspaceSlug: string, projectId: string, cycleId: string, issueId: string): Promise<void> {
  ...
  async removeIssue(workspaceSlug: string, projectId: string, cycleId: string, issueId: string): Promise<void> {
